...
void verifica_cliente(){
	...
	for(i=1; i <= total_clientes; i++){
			...
			printf("\n\t                                  %d || %s || %s || %s || %d, %d, %d", id_cliente[i],pessoa_cliente[i].nome_do_cliente,pessoa_cliente[i].cpf_do_cliente,pessoa_cliente[i].endereco_do_cliente,pessoa_cliente[i].rifa_cliente[0],pessoa_cliente[i].rifa_cliente[1],pessoa_cliente[i].rifa_cliente[2]);
